const WORKSHOPS = [
  ...
  { id: 'WS1-12',
    ...
    facilitatorId: 'Jose-Concepcion',
    name:
     'Jose Concepcion / Filipino Student Society of Wayne State University',
    bio:
     '<p>Jose Antonio Villanueva Concepcion, Electrical Engineer, Alumni from the Filipino Student Society of Wayne State University, is a self-taught martial arts enthusiast and passionate thespian of the performing arts. Jose was inspired to learn martial arts through movies and his younger brothers. His interests grew more learning different styles in Eastern culture and how they are represented today\'s media. For his workshop, he has solely focused on FMA, Filipino Martial Arts and hopes the students leave inspired too.</p>' },
  { id: 'WS1-13',
    session: 'WORKSHOP_SESSION_01',
    workshopId: 'Our-God',
    title: 'Dios Natin: "Our God"',
    description:
     '<p>How did the Catholic/Christian faith come to be in the Philippines and what does it mean for us today? How is Jesus healing the story of our people even though its pages include the pain of Spanish colonialism and American imperialism “in the name of Jesus?” Come and see how our identities of culture and faith intersect.</p>',
    facilitatorId: 'Kapwa',
    name: 'UIUC Kapwa',
    bio: '<p>Coming soon.</p>' },
  { id: 'WS1-14',
  ...
  { id: 'WS2-06',
    ...
    description:
     'You will be given a series of scenarios with choices to make. The choice you make impacts your path and outcome. ',
  ...
  { id: 'WS2-12',
    session: 'WORKSHOP_SESSION_02',
    workshopId: 'You-Belong',
    title:
     'You Belong: Navigating Societal and Cultural Pressures To Fit In',
    description:
    ...
    facilitatorId: 'Jennifer-Mendez',
    name:
     'Jennifer Mendez / Asian American Cultural Center Assistant Director',
    bio:
     '<p>A proud Chicagoan from Latinx-Asian American heritage, Jennifer is thankful for the opportunity to join FACT 2019 as a facilitator to share her experiences navigating college as a first-generation student. Her earned degrees include an MA from the University of Michigan Ann Arbor and a BA from the University of Illinois at Urbana-Champaign.</p>' },
  { id: 'WS2-13',
    session: 'WORKSHOP_SESSION_02',
    workshopId: 'Dance2eXpreSs',
    title: 'Dance2eXpreSs: Defining yourself through dance',
    description:
     '<p>Our goal is to inspire others to explore and express themselves through movement and music. At this workshop, you will be taught a choreographed dance by members of Dance2XS UIUC. Come and discover your destiny through dance with us!</p>',
    facilitatorId: 'Dance2XS-UIUC',
    name: 'Dance2XS UIUC',
    bio:
     '<p>Dance2XS UIUC is an urban dance team from the University of Illinois at Urbana-Champaign that performs around campus, in Chicago, and surrounding universities.</p>' },
  { id: 'WS2-14',
    session: 'WORKSHOP_SESSION_02',
    workshopId: 'Fearing-the-Tsinela',
    title: 'Fearing the Tsinela',
    description:
     '<p>The attendees of the workshop will be encouraged to reflect on their upbringing and how different cultural or situational contexts influence their interactions today. The workshop will include discussion and some cognitive mapping to give attendees an outlet to express both the positive and negative feelings they have around their upbringing. Priority will be placed on creating a safe space for attendants to be as vulnerable as they wish without judgment.</p>',
    facilitatorId: 'Daniel-Jefferson',
  ...
  { id: 'WS2-15',
    session: 'WORKSHOP_SESSION_02',
    workshopId: 'The-Fight-Against-Violence-Against-Women',
    title: 'The Fight Against Violence Against Women',
    description:
     '<p>One in four women experience some form of domestic violence in their lifetime, but survivors are stigmatized and shamed for sharing their experiences or seeking help. The mission of this workshop is to understand the dynamics and complexity of relationship violence, with a focus on Asian/-American and Filipino/-American statistics and cultural values that may cultivate cycles of abuse and stigma. By offering respect, support, and encouragement, we hope to inspire delegates to spread awareness and take action to fight violence, and in turn, lead to a future in which all people could define their own destiny.</p>',
    facilitatorId: 'Alpha-Phi-Gamma',
    name: 'Alpha Phi Gamma - UIUC Chapter',
    bio:
     '<p>Alpha Phi Gamma UIUC Charter was recently established on campus in April 2019 as our organization’s 17th Charter. We work to build a more inclusive, multicultural community by providing opportunities for self-advancement, with a focus on women empowerment. Our mission is to spread cultural awareness; to encourage academic excellence; to be in solidarity with other marginalized communities, and to empower all to become leaders in the world. We plan every initiative with purpose and to bring sustainable change for the greater community.</p>' },
  { id: 'WS2-16',
    session: 'WORKSHOP_SESSION_02',
    workshopId: 'Are-you-_____-enough',
    title: 'Are you _____ enough?',
    description:
     '<p>The workshop will discuss how identities and labels shape our interactions through the world with the perceived expectations and stereotypes that are instilled by society. With this workshop, individuals will be given the space to reflect and process past experiences while exploring ways to make a conscious effort in progressing forward.</p>',
    facilitatorId: 'Lily-Hurt',
    name: 'Lily Hurt - University of Kentucky FASO',
    bio:
     '<p>Lily Hurt is a 3rd Year student studying Psychology with a minor in Gender and Women\'s Studies. She is the current President of the Filipino American Student Organization while also taking the initiative in starting an Asian Greek interest group on the University of Kentucky\'s campus. She also holds other positions in the university\'s counseling and tutoring center. She strives to create more opportunities and platforms for Asian/American Pacific Islanders since the university is a predominantly white institution.</p>' },
  { id: 'WS3-00',
    session: 'WORKSHOP_SESSION_03',
    workshopId: 'Freshman-Workshop',
    title: 'Freshman Workshop',
    description:
     '<p>FRESHMEN MUST TAKE THIS WORKSHOP</p><p>FRESHMEN ONLY</p><p>This is an opportunity for freshmen to network and connect with one another. As freshmen, it is important to create new and meaningful relationships to foster personal and professional development. We have some fun activities planned and we look forward to seeing you guys soon!</p>',
    facilitatorId: 'Cathlyn-Ferolin-and-Jayana-Tabbilos',
    name: 'Cathlyn Ferolin & Jayana Tabbilos',
    bio:
     '<p>Cathlyn Ferolin (Cathy) is a senior majoring in Community Health with concentration in Health Planning & Administration with a minor in Business. She has served on the Philippine Student Association board as one of the Cultural Chairs in 2017-018 and was 1/2 of the Team FACT Managers for FACT 2018. She is also an active member in alpha Kappa Delta Phi International Sorority Inc. as the Vice President of Service.</p><p>Jayana Tabbilos (Jaya) is a senior majoring in Molecular and Cellular Biology. She has served on the Philippine Student Association board as Social Chair in 2017-2018 and was 1/2 of Hospitality for FACT 2018.</p><p>We\'re both very excited for the opportunity to meet all of you!</p>' },
  { id: 'WS3-01',
    session: 'WORKSHOP_SESSION_03',
    workshopId: 'Define-Your-Destiny-STEM',
    title:
     'Define Your Destiny: STEM (Science, Technology, Engineering and Mathematics)',
    description:
     '<p>In line with this year\'s theme, FACT is introducing a series of panels for our 3rd session workshops! We\'ll be having professionals in each field answering the questions YOU want to know! The full slate of panelists will be revealed soon, so stay tuned! This panel is dedicated to the STEM field.</p>',
    facilitatorId: 'Panel-STEM',
    name: 'Kevin Tee, and more panelist TBA',
    bio: '<p>Coming soon.</>' },
  { id: 'WS3-02',
    session: 'WORKSHOP_SESSION_03',
    workshopId: 'Define-Your-Destiny-Healthcare',
    title: 'Define Your Destiny: Healthcare',
    description:
     '<p>In line with this year\'s theme, FACT is introducing a series of panels for our 3rd session workshops! We\'ll be having professionals in each field answering the questions YOU want to know! The full slate of panelists will be revealed soon, so stay tuned! This panel is dedicated to the Healthcare field.</p>',
    facilitatorId: 'Panel-Health',
    name: 'Brian Guerrero, and more panelist TBA',
    bio: 'Coming soon.' },
  { id: 'WS3-03',
    session: 'WORKSHOP_SESSION_03',
    workshopId: 'Define-Your-Destiny-Education-and-Politics',
    title: 'Define Your Destiny: Education & Politics',
    description:
     '<p>In line with this year\'s theme, FACT is introducing a series of panels for our 3rd session workshops! We\'ll be having professionals in each field answering the questions YOU want to know! The full slate of panelists will be revealed soon, so stay tuned! This panel is dedicated to Education & Politics!</p>',
    facilitatorId: 'Panel-Ed-Pol',
    name: 'JR Kuo, and more panelist TBA',
    bio: '<p>Coming soon.</>' },
  { id: 'WS3-04',
    session: 'WORKSHOP_SESSION_03',
    workshopId: 'Define-Your-Destiny-Media-&-The-Arts',
    title: 'Define Your Destiny: Media & The Arts',
    description:
     '<p>In line with this year\'s theme, FACT is introducing a series of panels for our 3rd session workshops! We\'ll be having professionals in each field answering the questions YOU want to know! The full slate of panelists will be revealed soon, so stay tuned! This panel is dedicated to Media & the Arts.</p>',
    facilitatorId: 'Panel-Med-Art',
    name: 'Michelle Macrohan, Jon Taala, and more panelist TBA',
    bio: '<p>Coming soon.</p>' },
  { id: 'WS3-05',
    session: 'WORKSHOP_SESSION_03',
    workshopId: 'Define-Your-Destiny-Business-and-Finance',
    title: 'Define Your Destiny: Business & Finance',
    description:
     '<p>In line with this year\'s theme, FACT is introducing a series of panels for our 3rd session workshops! We\'ll be having professionals in each field answering the questions YOU want to know! The full slate of panelists will be revealed soon, so stay tuned! This panel is dedicated to Business & Finance.</p>',
    facilitatorId: 'Panel-Buis-Fin',
    name: 'Shane Carlin, and more panelist TBA',
    bio: '<p>Coming soon.</p>' } 
]
